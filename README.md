...
| `expo-custom-block-fixture.sb3` | `scripts/make-expo-custom-block-fixture.mjs` | Pixel-level expo × custom block (Phase 6 extended: SSA uniqueness + `var` mutable + fold pattern). Driven by `npm run measure:expo-custom-block` |
